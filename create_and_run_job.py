...
# -------------------------------
# Set these as environment vars before running:
...
resp = requests.post(create_url, headers=headers, data=json.dumps(job_definition))
...
resp = requests.post(run_url, headers=headers, json={"job_id": job_id})
resp.raise_for_status()
